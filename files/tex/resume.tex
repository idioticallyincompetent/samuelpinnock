...
\begin{tabular}{r| p{0.5\textwidth} c}
    \cvevent{2023 - bis heute}{Produktionsingenieur Optics / Laser in der EUV}{Trumpf Lasersystems for Semiconductor Manufacturing SE + Co. KG}{Ditzingen}{
        \begin{itemize}
            ...
            \item Ich verwalte Code-Repositories im Team über Azure Repos, inklusive Branch-Strategie und Pull-Request-Workflow für gemeinsam entwickelte Qualifizierungssoftware.
        \end{itemize} 
        }{}\\
...
\begin{tabular}{r @{\hspace{0.5em}}l}
     ...
     \bg{skilllabelcolour}{iconcolour}{Azure Services} & \barrule{0.3}{0.5em}{cvpurple} \\
    \end{tabular}
\end{minipage}
...
\section*{Methodenkompetenzen}
\begin{tabular}{r @{\hspace{0.5em}}l}
     \bg{skilllabelcolour}{iconcolour}{Hardware/Software-Integration} &  \barrule{0.3}{0.5em}{cvpurple}\\
     \bg{skilllabelcolour}{iconcolour}{Root-Cause-Analyse \& Abstellmaßnahmen} & \barrule{0.3}{0.5em}{cvgreen} \\
\end{tabular}
